...
<div class="overlay" id="overlay" style="z-index: 1001;">
        <div class="popup">
            ...
            $popupSimImage = "";
            $tableName = "vi_prepaid"; // Initialize tableName
            switch (strtolower($tableName)) {
                
                case "vi_prepaid":
                    $popupSimImage = "images/vi.png";
                    break;
    ...
    if ($result->num_rows >0) {
        ...
        <div class="card-container">
            ...
            while ($row = $result->fetch_assoc()) {
                $tableName = "vi_prepaid";
                $simImage = "images/vi.png";
                ?>
                <div class="card">
...
<?php
        displayCards("SELECT * FROM vi_prepaid where type='Combo'", "Combo", "vi_prepaid");
        displayCards("SELECT * FROM vi_prepaid where type='Truly Unlimited'", "Truly Unlimited", "vi_prepaid");
        displayCards("SELECT * FROM vi_prepaid where type='Data'", "Data", "vi_prepaid");
        displayCards("SELECT * FROM vi_prepaid where type='SMS'", "SMS", "vi_prepaid");
        displayCards("SELECT * FROM vi_prepaid where type='ISD'", "ISD", "vi_prepaid");
        displayCards("SELECT * FROM vi_prepaid where type='Talktime'", "Talktime", "vi_prepaid");
        displayCards("SELECT * FROM vi_prepaid where type='Disney Hotstar VIP'", "Disney Hotstar VIP", "vi_prepaid");
        displayCards("SELECT * FROM vi_prepaid where type='Entertainment'", "Entertainment", "vi_prepaid");
        displayCards("SELECT * FROM vi_prepaid where type='Plan Voucher'", "Plan Voucher", "vi_prepaid");
        ?>
