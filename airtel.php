...
<div class="overlay" id="overlay" style="z-index: 1001;">
        <div class="popup">
            ...
            $popupSimImage = "";
            $tableName = "airtel_prepaid"; // Initialize tableName
            switch (strtolower($tableName)) {
                
                case "airtel_prepaid":
                    $popupSimImage = "images/airtellogo.jpg";
                    break;
    ...
    if ($result->num_rows >0) {
        ...
        <div class="card-container">
            ...
            while ($row = $result->fetch_assoc()) {
                $tableName = "airtel_prepaid";
                $simImage = "images/airtellogo.jpg";
                ?>
                <div class="card">
...
<?php
        ...
        displayCards("SELECT * FROM airtel_prepaid where type='Data'", "Data", "airtel_prepaid");
        displayCards("SELECT * FROM airtel_prepaid where type='Truly Unlimited'", "Truly Unlimited", "airtel_prepaid");
        displayCards("SELECT * FROM airtel_prepaid where type='Talktime'", "Talktime", "airtel_prepaid");
        displayCards("SELECT * FROM airtel_prepaid where type='International Roaming'", "International Roaming", "airtel_prepaid");
        displayCards("SELECT * FROM airtel_prepaid where type='Other Packs'", "Other Packs", "airtel_prepaid");
        displayCards("SELECT * FROM airtel_prepaid where type='Plan Vouchers'", "Plan Vouchers", "airtel_prepaid");
        displayCards("SELECT * FROM airtel_prepaid where type='Disney Hotstar VIP'", "Disney Hotstar VIP", "airtel_prepaid");
        displayCards("SELECT * FROM airtel_prepaid where type='Entertainment'", "Entertainment", "airtel_prepaid");
        ?>
