...
<div class="overlay" id="overlay" style="z-index: 1001;">
        <div class="popup">
            ...
            $popupSimImage = "";
            $tableName = "bsnl_prepaid"; // Initialize tableName
...
<?php
        displayCards("SELECT * FROM bsnl_prepaid where type='Truly Unlimited'", "Truly Unlimited", "bsnl_prepaid");
        displayCards("SELECT * FROM bsnl_prepaid where type='Data'", "Data", "bsnl_prepaid");
        displayCards("SELECT * FROM bsnl_prepaid where type='VOICE Vouchers'", "VOICE Vouchers", "bsnl_prepaid");
        displayCards("SELECT * FROM bsnl_prepaid where type='ISD Vouchers'", "ISD Vouchers", "bsnl_prepaid");
        displayCards("SELECT * FROM bsnl_prepaid where type='OTHERS Vouchers'", "OTHERS Vouchers", "bsnl_prepaid");
        displayCards("SELECT * FROM bsnl_prepaid where type='Data Vouchers'", "Data Vouchers", "bsnl_prepaid");
        displayCards("SELECT * FROM bsnl_prepaid where type='General TOPUP'", "General TOPUP", "bsnl_prepaid");
        displayCards("SELECT * FROM bsnl_prepaid where type='PLAN Extension'", "PLAN Extension", "bsnl_prepaid");
        displayCards("SELECT * FROM bsnl_prepaid where type='SMS Vouchers'", "SMS Vouchers", "bsnl_prepaid");
        displayCards("SELECT * FROM bsnl_prepaid where type='Tr'", "Tr", "bsnl_prepaid");
