...
$simTableMapping = [
    "All" => ["airtel_postpaid", "jio_postpaid", "bsnl_postpaid", "vi_postpaid"],
    "Airtel" => ["airtel_postpaid"],
    "Jio" => ["jio_postpaid"],
    "BSNL" => ["bsnl_postpaid"],
    "Vi" => ["vi_postpaid"],
];
...
{
    $tableNames = ["airtel_postpaid", "jio_postpaid", "bsnl_postpaid", "vi_postpaid"];
            ...
            <script>
                ...
                function compareSelectedPlans() {
                    ...
                    if (totalSelected > 4) {
                        ...
                        if (queryString !== '') {
                            window.location.href = `pcompare.php?${queryString}`;
                        } else {
                ...
                function fetchDataAndStore() {
                    ...
                    var tableNames = ['airtel_postpaid', 'bsnl_postpaid', 'jio_postpaid', 'vi_postpaid'];
