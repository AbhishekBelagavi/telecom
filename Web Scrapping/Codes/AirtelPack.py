...
num_loads = 2  # Number of times to click "Load More"
for _ in range(num_loads):
    load_button = driver.find_element(By.XPATH, "/html/body/div[1]/div[3]/div[1]/div[3]/div[1]/div[4]/span")
    load_button.click()
    time.sleep(2)

fullinfo = 1  # Number of times to click "Load More"
for _ in range(fullinfo):
    load_button2 = driver.find_element(By.XPATH, "/html/body/div[1]/div[3]/div[1]/div[3]/div[1]/div[3]/div[2]/div[4]/span")
    load_button2.click()
    
    # Benefits_elements = driver.find_elements(By.CSS_SELECTOR, "div._bnfdtl._pvl ")
    # for benifit in Benefits_elements:
    #     print(benifit.text)
    time.sleep(2)
...
# df.to_excel("AirtelPack1.xlsx",index=True)
